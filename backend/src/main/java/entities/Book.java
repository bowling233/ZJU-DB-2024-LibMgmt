...
public final class Book {
    ...
    public Book(JSONObject json) {
        ...
        this.press = json.getString("press");
        this.publishYear = json.getInteger("publishYear");
    ...
    public String toJson() {
        ...
        jsonObject.put("publishYear", publishYear);
    ...
    public enum SortColumn {
        ...
        public static SortColumn fromString(String value) {
